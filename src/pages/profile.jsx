      ...
      <main className="flex-1 flex flex-col p-4 md:p-8">
        ...
        <div className="w-full max-w-5xl mx-auto mb-4 md:mb-6">
          <div className="flex items-center gap-3 p-4">
            ...
            <span className="font-['Poppins'] font-semibold text-lg sm:text-2xl leading-6 sm:leading-8 text-[#26231E]">Profile</span>
          </div>
        </div>
        ...
        <div className="w-full max-w-5xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-4 md:gap-8">
            ...
            <aside className="w-full lg:w-80 bg-transparent p-4 md:p-6">
              <nav className="space-y-4 md:space-y-6">
                ...
                <div className="grid grid-cols-2 gap-2 md:grid-cols-1 md:space-y-2 md:gap-0 pb-4">
                  <button className="w-full flex items-center gap-2 md:gap-4 p-3 md:p-4 text-left hover:bg-white hover:rounded-xl hover:shadow-sm transition-all">
                    <div className="w-4 h-4 md:w-5 md:h-5 flex items-center justify-center">
                      <svg className="w-4 h-4 md:w-5 md:h-5 text-[#43403B]" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/>
                      </svg>
                    </div>
                    <span className="font-['Poppins'] font-medium text-sm md:text-base leading-5 md:leading-6 text-[#43403B]">Profile</span>
                  </button>
                  ...
                  >
                    ...
                    <span className="font-['Poppins'] font-medium text-sm md:text-base leading-5 md:leading-6 text-[#75716B]">Reset password</span>
                  </button>
                </div>
              </nav>
            </aside>
            ...
            <div className="flex-1">
              <div className="w-full max-w-[550px] min-h-[652px] bg-[#EFEEEB] rounded-2xl p-6 sm:p-8 md:p-[40px] shadow-sm">
                {/* Profile Picture Section */}
                <div className="mb-6 md:mb-8 flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
                  ...
                  <div className="flex justify-center items-center w-full sm:w-auto">
                    ...
                    <label
                      ...
                      className="inline-flex items-center justify-center gap-[6px] w-full sm:w-[255px] h-[48px] px-6 sm:px-[40px] py-[12px] bg-white border border-[#75716B] rounded-full text-[#26231E] hover:bg-[#F5F3F0] transition-colors cursor-pointer font-['Poppins'] font-medium text-sm sm:text-base leading-6 text-center"
                    >
                ...
                <form onSubmit={handleSave} className="space-y-4 md:space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full h-10 sm:h-12 bg-white border border-[#DAD6D1] rounded-lg px-3 sm:px-4 text-[#26231E] focus:outline-none focus:ring-2 focus:ring-[#26231E] focus:border-transparent text-sm sm:text-base"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className="w-full h-10 sm:h-12 bg-[#F5F5F5] border border-[#DAD6D1] rounded-lg px-3 sm:px-4 text-[#75716B] cursor-not-allowed text-sm sm:text-base"
                      placeholder="Enter your email"
                      disabled
                    />
                  </div>

                  <div className="pt-2 md:pt-4 flex items-center justify-start">
                    <button
                      type="submit"
                      disabled={isSubmitting}
                      className="w-[141px] h-[48px] rounded-[999px] bg-[#26231E] px-6 sm:px-[40px] py-[12px] font-poppins font-medium text-sm sm:text-base leading-6 text-white hover:bg-[#3A342E] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
