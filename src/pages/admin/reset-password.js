        ...
        <main className="flex-1 p-8">
          <div className="max-w-md mx-auto">
            <div className="bg-white rounded-lg shadow p-8">
              <h3 className="text-xl font-semibold text-[#26231E] mb-6">Change Password</h3>
              
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label className="block mb-2 font-medium text-[#26231E] text-sm">
                    Current Password
                  </label>
                  <input
                    type="password"
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-[#26231E] text-white py-3 rounded-lg hover:bg-[#3A342E] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
