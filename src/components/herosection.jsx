...
const HeroSection = () => {
  return (
    <section className="flex justify-center items-center w-full md:w-[70vw] mt-12 md:mt-20 px-4">
      <div className="flex flex-col-reverse md:flex-row w-full">
        {/* Left Section - Inspiring Text */}
        <div className="flex-1 flex flex-col justify-center items-center md:items-end md:pr-4">
          <h1 className="text-[34px] leading-[40px] md:text-[52px] md:leading-[60px] font-semibold text-[#26231E] text-center md:text-right mb-4 font-['Poppins'] max-w-[540px] md:max-w-[347px]">
          Live your life <br />
          with happiness <br />
          every day.
          </h1>
          <p className="text-[15px] md:text-[16px] font-medium text-[#75716B] leading-[24px] text-center md:text-right font-['Poppins'] max-w-[540px] md:max-w-[347px]">
        ...
        <div className="flex-1 flex justify-center items-center md:px-4 mb-8 md:mb-0">
          <div className="w-[280px] h-[380px] md:w-[386px] md:h-[529px] rounded-2xl border-2 border-gray-300 overflow-hidden">
            <img src={meImage} alt="Profile" className="w-full h-full object-cover" loading="lazy" />
          </div>
        </div>

        {/* Right Section - Author Information */}
        <div className="flex-1 flex flex-col justify-center items-center md:items-start md:pl-4">
